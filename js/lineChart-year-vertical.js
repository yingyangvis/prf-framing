...
const contentGap = 40, lineChartGap = 80,
    ...
    faceLeftFlowX = 40, faceLeftFlowY = 5, faceRightFlowX = 90, faceRightFlowY = 25,
...
// load data
const speechData = await d3.json("data/results_speaker_affil_filtered_chars150to1200.json");
const diffData = await d3.csv("data/results_speaker_affil_filtered_chars150to1200_summary_table_dynamic.csv");
const electionData = await d3.csv("data/federal_elections.csv");
const pmData = await d3.csv("data/prime_minister_terms.csv");
const binData = await d3.csv("data/results_speaker_affil_filtered_chars150to1200_bin_edges.csv");
