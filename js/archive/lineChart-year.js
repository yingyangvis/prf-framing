...
sortedSpeakers.forEach((speaker, index) => {
	...
	speakers[speaker].groupedSpeeches = speakers[speaker].groupedSpeeches.sort(sortSpeechByYearAscending);
    ...
    svgGroup.selectAll(".circle")
		.data(speakers[speaker].groupedSpeeches)
		.join("g")
		.append("circle")
        .attr("fill", "white")
        .attr("stroke", "black")
		...
		.on("mouseover", function(event, d) {
			...
			d3.select("#tooltip-text")
				.html("<b>Speaker:</b> " + speaker + "<br/>" + 
					"<b>Date:</b> " + d3.timeFormat("%d %B %Y")(d.year) + "<br/>" + 
					"<b>Diff: </b>" + d.meanDiff.toFixed(2)
                    );
		})
})
...
function sortSpeechByYearAscending(a, b) {
